...
//         a: 'Bind your  bank account in the app, then tap Withdraw. Minimum withdrawal is $11.50. Processing takes 5 minutes to 48 hours.',
//     },
//     {
...
//     // On mobile, ONLY show in drawer (mobile=true), NOT in header
//     // On desktop, show in header (mobile=false)
//     return mobile ? (
//         <>
//             <Link
//                 to='/login'
//                 className='text-white/70 text-sm font-semibold text-center py-2 block'
//             >
//                 Sign In
//             </Link>
//             <Link
...
//         </>
//     ) : (
//         // Desktop header - show both buttons
...
//                         <span className='text-white font-extrabold text-sm leading-tight block'>
//                             Luminos Energy
//                         </span>
...
//                     {['How It Works', 'Plans', 'Testimonials', 'FAQ'].map(
//                         (item) => (
//                             <a
//                                 key={item}
...
//             >
//                 <span className='text-gray-800 font-bold text-sm pr-4'>
//                     {q}
//                 </span>
//                 <ChevronDown
//                     size={18}
...
//                 style={{
//                     background:
//                         'linear-gradient(135deg,#1C1A18 0%,#2D1F0E 50%,#1C1A18 100%)',
//                 }}
//             >
...
//                     style={{
//                         background:
//                             'radial-gradient(circle,rgba(198,123,44,0.2) 0%,transparent 70%)',
//                         filter: 'blur(40px)',
//                     }}
//                 />
//                 <div
...
//                     style={{
//                         background:
//                             'radial-gradient(circle,rgba(101,155,94,0.15) 0%,transparent 70%)',
//                         filter: 'blur(40px)',
//                     }}
//                 />
...
//                         style={{
//                             background: 'rgba(198,123,44,0.12)',
//                             borderColor: 'rgba(198,123,44,0.3)',
//                         }}
//                     >
...
//                         </span>
//                         <span
//                             className='text-[10px] sm:text-xs font-bold whitespace-normal text-center'
//                             style={{ color: '#C67B2C' }}
//                         >
...
//                             style={{
//                                 background:
//                                     'linear-gradient(135deg,#C67B2C,#F5C26B)',
...
//                         Invest in real solar energy infrastructure. Earn
//                         consistent weekday income. Withdraw to your bank account
//                         anytime.
//                     </p>
...
//                                 boxShadow: '0 8px 32px rgba(198,123,44,0.45)',
//                             }}
//                         >
...
//                             From signup to daily income in under 10 minutes. No
//                             experience required.
//                         </p>
//                     </div>
...
//                             Built for You. Designed to grow your wealth
//                             reliably, one weekday at a time.
//                         </p>
//                     </div>

//                     <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5'>
//                         {FEATURES.map(
//                             ({ icon: Icon, color, bg, title, desc }, i) => (
//                                 <div
//                                     key={i}
...
//                                         />
//                                     </div>
//                                     <h3 className='text-gray-800 font-extrabold text-base mb-2'>
//                                         {title}
//                                     </h3>
...
//                         </h2>
//                         <p className='text-white/50 max-w-xl mx-auto'>
//                             Start free and upgrade as you grow. Every plan earns
//                             real daily income from solar energy.
//                         </p>
//                     </div>
...
//                         More plans available after sign up · VIP4 &amp; VIP5
//                         available in-app
//                     </p>
//                 </div>
//             </section>
...
//                         </h2>
//                         <p className='text-gray-500 max-w-xl mx-auto'>
//                             Real stories from Users building wealth with solar
//                             energy investments.
//                         </p>
//                     </div>
...
//                 style={{
//                     background:
//                         'linear-gradient(135deg,#1C1A18 0%,#2D1F0E 100%)',
//                 }}
//             >
...
//                         Join 900,000+ Users already earning daily returns from
//                         solar energy. Create your free account in 2 minutes.
//                     </p>
...
//                                 background:
//                                     'linear-gradient(135deg,#C67B2C,#A25F1F)',
//                                 boxShadow: '0 8px 32px rgba(198,123,44,0.4)',
//                             }}
//                         >
...
//                                 World's leading solar-backed investment
//                                 platform. Earn daily returns from real solar
...
//                                         key={item}
//                                         href='#'
//                                         className='block text-white/45 hover:text-white text-sm transition-colors'
//                                     >
//                                         {item}
//                                     </a>
//                                 ))}
