...
import { VipGateModal } from '../../components/common/MobileSupportButton'
...
const Account = () => {
    ...
    const GRID = [
        ...
        {
            icon: KeyRound,
            label: 'Modify Withdraw PIN',
            path: '/main/change-withdraw-pin',
            color: '#0f766e',
            bg: '#f0fdfa',
        },
        {
                ...
                <div className='px-4 mt-4'>
                    <div className='grid grid-cols-3 gap-3'>
                        {[...Array(12)].map((_, i) => (
                            <div
                                key={i}
                                className='flex flex-col items-center justify-center gap-1.5 p-2.5 rounded-2xl bg-primary-deep/10 border border-primary/20'
                            >
    ...
    return (
        <div className='min-h-dvh pb-24'>
            ...
            {/* Support Modal */}
            {/* VIP Gate */}
            {modal === 'support' && user?.vipLevel === 0 && (
                <VipGateModal onClose={() => setModal(null)} />
            )}

            {/* Support Modal — only for VIP 1+ */}
            <Modal
                isOpen={modal === 'support' && user?.vipLevel > 0}
            ...
            >
                <div className='text-center space-y-4'>
                    ...
                    <div>
                        <p className='text-gray-600 text-sm leading-relaxed'>
                            The mobile app is coming soon! Stay tuned for
                            updates.
                        </p>
                    </div>
                    <button
            ...
            >
                <div className='text-center space-y-4'>
                    ...
                    <div>
                        <p className='text-gray-600 text-sm leading-relaxed'>
                            Salary feature is coming soon. We're working hard to
