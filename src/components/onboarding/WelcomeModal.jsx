...
const features = [
    {
        ...
        desc: 'Grow your capital with solar-backed plans',
    },
    {
        icon: Users,
        color: '#8b5cf6',
        bg: '#ede9fe',
        label: 'Team Rewards',
        desc: 'Earn 8% on every referral investment',
    },
    {
        icon: Zap,
        color: '#f59e0b',
        ...
        desc: 'Claim bonuses every day just by showing up',
    },
    {
        icon: Shield,
        color: '#1a9fd4',
        ...
        desc: 'Bank-grade security on all your transactions',
    },
]
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    animation:
                        'modalIn 0.45s cubic-bezier(0.34,1.56,0.64,1) both',
                    background:
                        'linear-gradient(145deg, rgba(30,25,20,0.97) 0%, rgba(20,15,10,0.99) 100%)',
                    border: '1px solid rgba(198,123,44,0.25)',
                    boxShadow:
                        '0 32px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(198,123,44,0.1), inset 0 1px 0 rgba(255,255,255,0.06)',
                }}
            >
                {/* Close */}
                <button
                ...
                <div
                    ...
                    style={{
                        background:
                            'radial-gradient(circle, rgba(198,123,44,0.15) 0%, transparent 70%)',
                    }}
                />
                <div
                    ...
                    style={{
                        background:
                            'radial-gradient(circle, rgba(26,159,212,0.1) 0%, transparent 70%)',
                    }}
                />
                ...
                <div className='relative p-6 pt-8'>
                    ...
                    <div className='flex justify-center mb-5'>
                        <div
                            ...
                            style={{
                                background:
                                    'linear-gradient(135deg, rgba(198,123,44,0.3), rgba(198,123,44,0.1))',
                    ...
                    <div className='text-center mb-6'>
                        ...
                        <p className='text-white/50 text-sm leading-relaxed'>
                            ...
                            — a solar-powered investment platform designed to
                            grow your wealth.
                        </p>
                    </div>
                        ...
                        {features.map(
                            ({ icon: Icon, color, bg, label, desc }) => (
                                ...
                                >
                                    ...
                                    <p className='text-white text-xs font-bold leading-tight mb-0.5'>
                                        {label}
                                    </p>
